  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header">
        ...
        text-sm mt-1">Manage your settings</p>
      </div>
      ...
      <div className="profile-content">
        ...
        <Card>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400
              text-xs">Member since {new Date(user?.createdAt || '').
          ...
          {isEditing ? (
            <div className="space-y-4">
              ...
              onChange={(v)=>setFormData({...formData, age:
              Number(v)})} min={13} max={120}/>

              <Input label="Weight (kg)" type="number" value={formData.weight}
              onChange={(v)=>setFormData({...formData, weight:
              Number(v)})} min={20} max={300}/>

              <Input label="Height (cm)" type="number" value={formData.height}
              onChange={(v)=>setFormData({...formData, height:
              Number(v)})} min={100} max={250}/>

              <Select label="Fitness Goal" value={formData.goal as string}
              onChange={(v)=> setFormData({...formData, goal: v as 
              'lose' | 'maintain' | 'gain'})} options={goalOptions}/>
                ...
                <Button variant="secondary" className="flex-1"
                  onClick={()=>{
                    ...
                    setFormData({
                      ...
                      goal: (user.goal || 'maintain') as 'lose' | 'maintain' | 'gain',
                      dailyCalorieIntake: user.dailyCalorieIntake || 2000,
                      dailyCalorieBurn: user.dailyCalorieBurn || 400
                    })
                  }}>
            ...
            <div className="space-y-4">
              ...
              duration-200">
                ...
                <div>
                  ...
                  dark:text-white">{user.age} years</p>
                </div>
              </div>
              ...
              duration-200">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-800
                  dark:text-white">{user.weight} kg</p>
                </div>
              </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-slate-50
                  ...
                  duration-200">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-slate-800
                       dark:text-white">{user.height} cm</p>
                    </div>
                </div>
              )}
              ...
              duration-200">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-800
                  dark:text-white">{goalLabels[user?.goal || 'gain']}</p>
                </div>
              </div>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              dark:bg-emerald-900/10 rounded-xl">
                ...
                dark:bg-emerald-400">{stats.totalFoodEntries}</p>
                <p className="text-sm text-slate-500
          ...
          <Button variant="danger" onClick={logout} className="w-full
           ring ring-red-300 hover:ring-red-200">
