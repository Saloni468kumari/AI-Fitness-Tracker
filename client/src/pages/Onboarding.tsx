    ...
    <>
      ...
      <div className="onboarding-container">
        ...
        <div className="px-6 mb-8 onboarding-wrapper">
          ...
          <p className="text-sm text-slate-400 mt-3">Step
            {step} of {totalSteps}</p>
        </div>
            ...
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400
                  text-sm">Help us track your progress</p>
                </div>
              </div>
            ...
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400
                  text-sm">We'll tailor your experience</p>
                </div>
              </div>
                ...
                {goalOptions.map((option)=>(
                  <button
                   ...
                   onClick={()=> {
                    ...
                    const range = ageRanges.find((r)=>age
                     <= r.max) || ageRanges[ageRanges.length - 1]
                   ...
                   option.value && 'ring-2 ring-emerald-500'}`}>
                    <span className="text-base text-slate-700
                     dark:text-slate-200">{option.label}</span>
                  </button>
                ))}
              </div>
              ...
              <div className="space-y-8 max-w-lg">
                ...
                <div className="space-y-6">
                  ...
                  value={formData.dailyCalorieIntake} onChange={(v)=>updateField
                  ('dailyCalorieIntake', v)} unit="kcal" infoText="The total
                   calories you plan to consume each day."/>

                  <Slider label="Daily Calorie Burn" min={100} max={2000} step={50}
                  value={formData.dailyCalorieBurn} onChange={(v)=>updateField
                  ('dailyCalorieBurn', v)} unit="kcal" infoText="The total calories
                   you aim to burn through exercise and activity each day."/>
                </div>
              </div>
            </div>
          )}
